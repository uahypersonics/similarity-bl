...
def get_initial_guess(
    ...
    # adiabatic: key = (mach, beta, sweep_angle, temp_edge),  values = (fpp_wall, gcfp_wall, g_wall)
    ...
    if key_values.get("sweep_angle", None) == 0.0:
        from simbl.solver.falkner_skan.initial_guess import (
            get_initial_guess as fs_get_initial_guess,
        )
        ...
        fs_guess = fs_get_initial_guess(wall_bc, fs_key_values)
